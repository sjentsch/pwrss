...
- n.paired:
  ...
  number of pairs, which is sum of cell frequencies in 2 x 2 table
...
- alternative:
  ...
  character; the direction or type of the hypothesis test: "not equal",
  "greater", "less". Optionally, users can specify 'two.sided' as an
  alternative to 'not equal' for consistency with other R statistical
  functions.
...
- n.paired:
  ...
  paired sample size, which is sum of cell frequencies in 2 x 2 table
  (f11 + f10 + f01 + f00), or number of rows in a data frame with
...
[doi:10.2307/2531151](https://doi.org/10.2307/2531151)
...
[doi:10.2307/2528039](https://doi.org/10.2307/2528039)
