test_that("proportions.gof.R works", {
    ...
    expect_equal(names(crrRes), c("parms", "test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n"))
    expect_equal(crrRes[["parms"]],
                 list(w = NULL, null.w = 0, df = mtxW$df, n = 41, power = 0.80, alpha = 0.05, ceiling = TRUE,
                      verbose = 0, utf = FALSE))
    expect_equal(crrRes[c("test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n")],
                 list(test = "Chi-Square Test for Goodness-of-Fit or Independence", df = mtxW$df, ncp = 7.8486511, null.ncp = 0,
                      chisq.alpha = 3.84145882, w = 0.43752773, power = 0.79998954, n = 41))
    ...
    expect_equal(crrRes[c("test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n")],
                 list(test = "Chi-Square Test for Goodness-of-Fit or Independence", df = mtxW$df, ncp = 7.8504063, null.ncp = 0,
                      chisq.alpha = 3.84145882, w = mtxW$w, power = 0.80007722, n = 463))
    ...
    expect_equal(names(crrRes), c("parms", "test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n"))
    expect_equal(crrRes[["parms"]],
                 list(w = NULL, null.w = 0, df = mtxW$df, n = 463, power = 0.80, alpha = 0.05, ceiling = TRUE,
                      verbose = 0, utf = FALSE))
    expect_equal(crrRes[c("test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n")],
                 list(test = "Chi-Square Test for Goodness-of-Fit or Independence", df = mtxW$df, ncp = 7.8461815, null.ncp = 0,
                      chisq.alpha = 3.84145882, w = 0.130178325, power = 0.7998661, n = 463))
    ...
    expect_equal(crrRes[c("test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n")],
                 list(test = "Chi-Square Test for Goodness-of-Fit or Independence", df = mtxW$df, ncp = 11.9353027, null.ncp = 0,
                      chisq.alpha = 9.48772904, w = mtxW$w, power = 0.80000063, n = 13069))
    ...
    expect_equal(names(crrRes), c("parms", "test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n"))
    expect_equal(crrRes[["parms"]],
                 list(w = NULL, null.w = 0, df = mtxW$df, n = 13069, power = 0.80, alpha = 0.05, ceiling = TRUE,
                      verbose = 0, utf = FALSE))
    expect_equal(crrRes[c("test", "df", "ncp", "null.ncp", "chisq.alpha", "w", "power", "n")],
                 list(test = "Chi-Square Test for Goodness-of-Fit or Independence", df = mtxW$df, ncp = 11.9548133, null.ncp = 0,
                      chisq.alpha = 9.48772904, w = 0.030244765, power = 0.800734563, n = 13069))
