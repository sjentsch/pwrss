test_that("regression.logistic.R works", {
    ...
    expect_equal(crrRes[["parms"]],
                 list(base.prob = 0.15, prob = 0.200000038, beta0 = -1.734601055, beta1 = 0.34830693, odds.ratio = 1.416667,
                      ...
                      distribution = list(dist = "bernoulli", prob = 0.25077), ceiling = TRUE, verbose = 0, pretty = FALSE))
    expect_equal(crrRes[c("test", "odds.ratio", "mean", "sd", "vcf", "null.mean", "null.sd", "z.alpha", "power", "n")],
    ...
    expect_message(power.z.logistic(base.prob = 0.15, beta1 = 0.80, beta0 = 0.2, alpha = 0.05, power = 0.80, distribution = "normal", verbose = FALSE),
                   "Using `base.prob` and `beta1`, ignoring any specifications to `prob`, `beta0`, or `odds.ratio`.")
    expect_message(power.z.logistic(prob = 0.2, beta1 = 0.80, beta0 = 0.2, alpha = 0.05, power = 0.80, distribution = "normal", verbose = FALSE),
    ...
    expect_error(power.z.logistic(base.prob = 0.20, prob = 0.40, alpha = 0.05, power = 0.80, n = 50, distribution = "normal", verbose = FALSE),
    ...
    expect_error(power.z.logistic(base.prob = 0.20, prob = 0.40, alpha = 0.05, power = 0.80,
                 ...
                 "Unknown input type for `distribution`")
    expect_error(power.z.logistic(base.prob = 0.20, prob = 0.40, alpha = 0.05, power = 0.80, distribution = NA, verbose = FALSE),
                 "Unknown input type for `distribution`")
    expect_error(power.z.logistic(base.prob = 0.20, prob = 0.40, alpha = 0.05, power = 0.80,
